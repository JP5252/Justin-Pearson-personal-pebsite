...
rounded-lg border border-solid border-green-700 text-center group cursor-pointer
hover:border-green-400 duration-200"
>
  <div
    class="bg-slate-950 rounded grid place-items-center px-4 text-5xl md:text-6xl -mt-10
